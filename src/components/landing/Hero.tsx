            ...
            <MaxWidthWrapper className="relative z-10 mb-8 md:mb-12 mt-0 md:mt-12">
                <div className="flex flex-col items-center justify-center text-center px-4 sm:px-6">
                    ...
                    >
                        ...
                        <button className="px-6 py-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/10 text-white font-medium hover:bg-white/20 transition-colors">
                            Watch Demo
                        </button>
                    </motion.div>
