...
export default function SwitchTab({ uploadMethod, setUploadMethod }: SwitchTabProps) {
            ...
            <div className="relative rounded-xl flex justify-center">
                <div className="bg-gray-800/50 rounded-full grid grid-cols-2 w-full max-w-md p-2 gap-1">
                    <motion.button
                        ...
                        className={`relative rounded-full px-6 py-3 flex items-center justify-center gap-2 transition-all duration-300 ${uploadMethod === 'link' ? 'text-white' : 'text-gray-400 hover:text-gray-300'
                            }`}
                    >
                        {uploadMethod === 'link' && (
                            <motion.div
                    ...
                    <motion.button
                        ...
                        className={`relative rounded-full px-6 py-3 flex items-center justify-center gap-2 transition-all duration-300 ${uploadMethod === 'video' ? 'text-white' : 'text-gray-400 hover:text-gray-300'
                            }`}
                    >
                        {uploadMethod === 'video' && (
                            <motion.div
